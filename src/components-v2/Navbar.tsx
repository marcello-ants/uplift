...
import { navbarLinks, mobileExtraLinks } from '../data-v2/navbar'
...
const Navbar = ({
    ...
    const classNames = classnames('relative flex flex-row items-center space-x-4 h-[80px] transition-all', {
            ...
            <div className={classNames}>
                    ...
                    <Link href='/'>
                        <a>
                            <img
                                ...
                                className='cursor-pointer w-[144px] min-w-[144px]'
                                alt='Logo'
                            />
                        </a>
                    </Link>
                    {/* DESKTOP LINKS */}
                    <nav className='hidden lg:block pl-4'>
                        <ul className='flex flex-row space-x-6 items-center'>
                            {navbarLinks.map((navLink) => (
                                <li
                                    key={navLink.label}
                                    className='text-black hover:text-gray-500 transition-all whitespace-nowrap'>
                ...
                <div className='flex-1 flex justify-end'>
                    ...
                    <div className='hidden lg:flex items-center'>
                        <div className='font-satoshi text-black hover:text-gray-500 px-8 transition-all whitespace-nowrap'>
                            <Link href={'https://app.framework.so/user/signin'}>Sign in</Link>
                        </div>
                        <Button variant='outlined' link={SHARED_DATA.DEFAULT_TRIAL_LINK}>
                            Start free trial
                        </Button>
                    </div>
                    <button
