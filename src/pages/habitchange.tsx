            ...
            <main>
                <div className='flex flex-col'>
                    <div className='flex flex-col space-y-28 pb-28'>
                        <Hero
                            headerText='Supercharge new habits'
                            subheaderText='Harness the power of scientifically proven tools like goal-setting, journaling, streak counters and assessments to create highly engaging challenges that allow you to scale your impact.'
                        />
                        <Explainer />
