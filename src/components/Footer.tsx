        ...
        <div className='max-w-screen-xl mx-auto pl-10 py-20'>
            <div className='flex flex-col lg:flex-row mb-10 space-y-10 lg:space-y-0'>
                <div className='flex-1'>
                    <Link href='/'>
                        <a>
                            <img src='/images/logomark.svg' className='cursor-pointer w-[32px] opacity-70' alt='Logo' />
                        </a>
                    </Link>
                </div>
                        ...
                        <nav>
                            <ul>
                                ...
                                {footerProduct.map((link) => (
                                    <li
                                        key={link.label}
                                        className='font-satoshi text-gray-500 hover:text-black transition-all mt-3'>
